...
async def yt(ctx, *, query: str):
	req = requests.get('https://www.googleapis.com/youtube/v3/search?part=id&eventType=completed&maxResults=1&q={}&safeSearch=moderate&type=video&key='.format(query) + os.environ['YOUTUBE_API_KEY'])
